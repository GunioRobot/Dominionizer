namespace Dominionizer.Phone.Core.Sets
{
    ...
    public class DominionCards : List<Card>
    {
        ...
        private void Initialize()
        {
            ...
            this.Add(new Card(103, CardSet.Dominion, "Moat", 2, 0, CardType.Reaction, additionalCards: 2,
            ...
            this.Add(new Card(104, CardSet.Dominion, "Chancellor", 3, 0, CardType.Action, additionalCoin: 2,
                actionText: "You may immediately put your deck into your discard pile."));

            this.Add(new Card(105, CardSet.Dominion, "Village", 3, 0, CardType.Action, additionalCards: 1, additionalActions: 2));

            this.Add(new Card(106, CardSet.Dominion, "Woodcutter", 3, 0, CardType.Action, additionalBuys: 1, additionalCoin: 2));
            ...
            this.Add(new Card(111, CardSet.Dominion, "Militia", 4, 0, CardType.Attack, additionalCoin: 2,
            ...
            this.Add(new Card(114, CardSet.Dominion, "Smithy", 4, 0, CardType.Action, additionalCards: 3));

            this.Add(new Card(115, CardSet.Dominion, "Spy", 4, 0, CardType.Attack, additionalCards: 1, additionalActions: 1,
            ...
            this.Add(new Card(119, CardSet.Dominion, "Council Room", 5, 0, CardType.Action, 4, 1,
                actionText: "Each other player draws a card."));

            this.Add(new Card(120, CardSet.Dominion, "Festival", 5, 0, CardType.Action, 2, 1, 0, 2));

            this.Add(new Card(121, CardSet.Dominion, "Laboratory", 5, 0, CardType.Action, 1, 0, 2));
            ...
            this.Add(new Card(122, CardSet.Dominion, "Market", 5, 0, CardType.Action, 1, 1, 1, 1));
            ...
            this.Add(new Card(124, CardSet.Dominion, "Witch", 5, 0, CardType.Attack, additionalCards: 2,
